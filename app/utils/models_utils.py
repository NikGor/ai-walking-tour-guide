...
if TYPE_CHECKING:
    from app.agent.models.chat_models import ChatMessage, LllmTrace
...
def calculate_conversation_llm_trace(
    ...
    """
    from app.agent.models.chat_models import InputTokensDetails, LllmTrace, OutputTokensDetails
